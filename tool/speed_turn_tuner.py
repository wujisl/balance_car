...
class BalanceTuningPage(QWidget):
    ...
    def _build_ui(self):
        ...
        self.kp_spin = self._spin(0.0, 100.0, 0.15, 5, 0.001)
        tuning_grid.addWidget(self.kp_spin, 0, 1)
        tuning_grid.addWidget(QLabel("角度 Kd:"), 0, 2)
        self.kd_spin = self._spin(0.0, 100.0, 0.003, 5, 0.0005)
        ...
        self.ki_spin = self._spin(0.0, 100.0, 0.002, 5, 0.0005)
...
class VehicleTuningOverview(QWidget):
    ...
    def _build_ui(self):
        ...
        self.vision_period_spin = self._spin(100.0, 5000.0, 400.0, 0, 100.0)
